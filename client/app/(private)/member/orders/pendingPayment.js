...
console.log('data.transactions:', data.transactions)
  ...
  const fetchDynamicData = async (transactions) => {
    transactions.forEach(async (transaction) => {
      const collectionName = typeMapping[transaction.type] || "unknownCollection";
      ...
      if (collectionName !== "unknownCollection") {
        ...
        try {
          ...
          if (response.ok) {
            ...
            console.log(`Fetched data for ${collectionName} with detail ${transaction.detail}:`, data);
          ...
          console.error(`Error fetching data for ${collectionName} with detail ${transaction.detail}:`, error);
        }
      } else {
